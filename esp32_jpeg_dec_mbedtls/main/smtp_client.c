...
void send_email(unsigned char *image_data, unsigned int size)
{
    uint8_t *esp_logo_png_start = image_data;
    uint8_t *esp_logo_png_end = image_data + size + 1;
    char *buf = NULL;
